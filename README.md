...
29 Sept 2018 - Updated info for new version of board that can now be configed to use sleep mode using battery (no voltage reg for sleeping). Solder jumpers were added to disable Power LED and I2C pullups. Check sleep directory for info.

I will add more info on this board as I have time.
